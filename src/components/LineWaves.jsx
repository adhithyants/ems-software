...
void main() {
  ...
  float intensity = (pattern + lines * ridge);
  
  // Create a unified color transition to avoid green/cyan shifts
  float cycleT = fullT * uColorCycleSpeed;
  float shimmer = cos(blended.y + cycleT * 0.234) * 0.5 + 0.5;
  
  // Mixed color based on intensity and shimmer
  vec3 baseCol = mix(uColor3, uColor1, shimmer * 0.7 + 0.3);
  vec3 col = baseCol * intensity * uBrightness;
