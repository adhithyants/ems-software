    ...
    useEffect(() => {
        ...
        class Particle {
            ...
            draw() {
                ...
                ctx.shadowColor = 'rgba(255, 123, 0, 0.37)';
        ...
        const init = () => {
            const count = Math.min(Math.floor(window.innerWidth / 12), 150); // Increased density
            ...
            for (let a = 0; a < particles.length; a++) {
                for (let b = a; b < particles.length; b++) {
                    ...
                    if (dist < 150) { // Increased connection distance
                        ctx.beginPath();
                        ctx.strokeStyle = `rgba(255, 122, 0, ${0.2 - dist / 750})`; // Bolder lines
                        ctx.lineWidth = 0.8;
    ...
    return (
        <canvas
            ...
            style={{
                ...
                pointerEvents: 'none',
                zIndex: 0,
                opacity: 0.9 // Increased total opacity
            }}
        />
    );
};
